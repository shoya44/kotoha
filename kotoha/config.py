...
NOTIFY_GAP_MINUTES = _number("KOTOHA_NOTIFY_GAP_MINUTES", float, minimum=0)
SNOOZE_MINUTES = _number("KOTOHA_SNOOZE_MINUTES", minimum=0)
...
HABITS_MAX_TOKENS = _number("KOTOHA_HABITS_MAX_TOKENS")
...
# 記憶の強さ（memory/strength.py）。床を切ると消える。使うと GAIN ぶん強くなる。
